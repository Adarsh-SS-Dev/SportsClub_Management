...
urlpatterns = [
    path('registration', views.index, name='registration'),  # Added name for consistency
    path('user_home/', views.user_home, name='user_home'),  # Consistent naming
    ...
    # Updated these lines to use <int:id> instead of regex
